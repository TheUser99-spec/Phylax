...
- ✅ [03-manifest-policy.md] — phylax.toml schema completo
...
| `reload_project()` | ~520 | 0 | 🔴 Hot-reload phylax.toml |
...
| 006 | phylax.toml backward compatibility | Media |
...
- Hot-reload phylax.toml test (1.5h)
